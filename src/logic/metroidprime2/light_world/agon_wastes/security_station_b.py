...
class SecurityStationB(MetroidPrime2Region):
    ...
    def __init__(self, region_name: str, player: int, multiworld: MultiWorld):
        ...
        self.add_location(
            name="Event - Main Reactor Reloaded via Security Station B",
            locked_item=MetroidPrime2Item(
                name="Agon Wastes - Security Station B | Event - Main Reactor Reloaded via Security Station B",
