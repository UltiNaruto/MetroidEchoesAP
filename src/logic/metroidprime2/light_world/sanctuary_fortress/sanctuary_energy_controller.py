...
class SanctuaryEnergyController(MetroidPrime2Region):
    ...
    def __init__(self, region_name: str, player: int, multiworld: MultiWorld):
        ...
        self.add_location(
            name="Pickup (Cobalt Translator)",
            can_access=lambda state, player: True,
        )

        self.add_location(
            name="Event - Sanctuary Energy Returned",
            locked_item=MetroidPrime2Item(
                name="Sanctuary Fortress - Sanctuary Energy Controller | Event - Sanctuary Energy Returned",
                classification=ItemClassification.progression,
                code=None,
                player=player,
            ),
            can_access=lambda state, player: state.has("Ing Hive - Hive Energy Controller | Event - Ing Hive Energy Taken", player),
        )
