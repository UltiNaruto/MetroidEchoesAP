...
class PortalChamberLight(MetroidPrime2Region):
    name = "Portal Chamber (Light)"
    exits_ = [
        MetroidPrime2Exit(
            destination="P|Dark Torvus Bog - Portal Chamber (Dark)",
        ...
        MetroidPrime2Exit(
            destination="Torvus Bog - Torvus Lagoon",
            door=DoorCover.Any,
            rule=lambda state, player: condition_and([
                state.has("Morph Ball", player),
                condition_or([
