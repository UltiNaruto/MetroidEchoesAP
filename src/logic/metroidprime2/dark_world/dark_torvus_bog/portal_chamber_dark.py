...
class PortalChamberDark(MetroidPrime2Region):
    name = "Portal Chamber (Dark)"
    exits_ = [
        MetroidPrime2Exit(
        ...
        MetroidPrime2Exit(
            destination="P|Torvus Bog - Portal Chamber (Light)",
        ...
        MetroidPrime2Exit(
            destination="Dark Torvus Bog - Poisoned Bog",
            door=DoorCover.Any,
