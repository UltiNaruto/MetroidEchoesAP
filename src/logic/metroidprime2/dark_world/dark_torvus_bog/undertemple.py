...
class Undertemple(MetroidPrime2Region):
    name = "Undertemple"
    exits_ = [
        MetroidPrime2Exit(
            ...
            rule=lambda state, player: condition_and([
                condition_and([
                condition_and([
                state.has("Dark Torvus Bog - Undertemple | Event - Power Bomb Guardian", player),
                condition_or([
        ...
        MetroidPrime2Exit(
            destination="P|Torvus Bog - Main Hydrochamber",
    ...
    def __init__(self, region_name: str, player: int, multiworld: MultiWorld):
        ...
        self.add_location(
            name="Event - Power Bomb Guardian",
            locked_item=MetroidPrime2Item(
                name="Dark Torvus Bog - Undertemple | Event - Power Bomb Guardian",
        ...
        self.add_location(
            name="Event - Blast Shield Destroyed by Power Bomb Guardian",
            locked_item=MetroidPrime2Item(
                name="Dark Torvus Bog - Undertemple | Event - Blast Shield Destroyed by Power Bomb Guardian",
                classification=ItemClassification.progression,
                code=None,
                player=player,
            ),
