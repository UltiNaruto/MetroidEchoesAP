...
class UndertempleAccess(MetroidPrime2Region):
    name = "Undertemple Access"
    exits_ = [
        MetroidPrime2Exit(
            destination="P|Torvus Bog - Hydrodynamo Shaft",
        ...
        MetroidPrime2Exit(
            destination="Dark Torvus Bog - Undertemple",
        ...
        MetroidPrime2Exit(
            destination="Dark Torvus Bog - Undertemple Shaft",
            door=DoorCover.PowerBomb,
