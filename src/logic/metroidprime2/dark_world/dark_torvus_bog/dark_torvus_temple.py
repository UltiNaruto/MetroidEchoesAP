...
class DarkTorvusTemple(MetroidPrime2Region):
    name = "Dark Torvus Temple"
    exits_ = [
        MetroidPrime2Exit(
            destination="Dark Torvus Bog - Ammo Station",
            door=DoorCover.Any,
            rule=lambda state, player: condition_and([
                ...
                condition_and([
                state.has("Dark Torvus Bog - Dark Torvus Temple | Event - Chykka", player),
                condition_or([
                    has_dark_suit(state, player),
                    has_light_suit(state, player),
                    state.count("Energy Tank", player) >= 1,
        ...
        MetroidPrime2Exit(
            destination="Dark Torvus Bog - Dark Torvus Temple Access",
        ...
        MetroidPrime2Exit(
            destination="Dark Torvus Bog - Dark Controller Access",
            door=DoorCover.Any,
            rule=lambda state, player: condition_and([
                state.has("Space Jump Boots", player),
                condition_or([
        ...
        MetroidPrime2Exit(
            destination="Dark Torvus Bog - Cache B",
            door=DoorCover.Any,
            rule=lambda state, player: condition_and([
                condition_and([
                condition_and([
    ...
    def __init__(self, region_name: str, player: int, multiworld: MultiWorld):
        ...
        self.add_location(
            ...
            locked_item=MetroidPrime2Item(
                name="Dark Torvus Bog - Dark Torvus Temple | Event - Chykka",
                classification=ItemClassification.progression,
                code=None,
                player=player,
            ),
            can_access=lambda state, player: condition_and([
                state.has("Dark Torvus Key 1", player),
                state.has("Dark Torvus Key 2", player),
                state.has("Dark Torvus Key 3", player),
                condition_or([
                    has_dark_suit(state, player),
                    has_light_suit(state, player),
                    state.count("Energy Tank", player) >= 1,
