...
class DarkArenaTunnel(MetroidPrime2Region):
    name = "Dark Arena Tunnel"
    exits_ = [
        MetroidPrime2Exit(
            destination="Dark Torvus Bog - Dark Forgotten Bridge",
            door=DoorCover.Light,
            rule=lambda state, player: True,
        ),
        MetroidPrime2Exit(
            destination="Dark Torvus Bog - Dark Torvus Arena",
            door=DoorCover.Any,
