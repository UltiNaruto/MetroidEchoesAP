...
class SacrificialChamber(MetroidPrime2Region):
    ...
    exits_ = [
        MetroidPrime2Exit(
            ...
            rule=lambda state, player: condition_and([
                condition_and([
                state.has("Dark Torvus Bog - Sacrificial Chamber | Event - Grapple Guardian", player),
                condition_or([
    ...
    def __init__(self, region_name: str, player: int, multiworld: MultiWorld):
        ...
        self.add_location(
            name="Event - Grapple Guardian",
            locked_item=MetroidPrime2Item(
                name="Dark Torvus Bog - Sacrificial Chamber | Event - Grapple Guardian",
