...
class Crossroads(MetroidPrime2Region):
    name = "Crossroads"
    exits_ = [
        MetroidPrime2Exit(
            destination="P|Agon Wastes - Transport Center",
            ...
            rule=lambda state, player: condition_and([
                ...
                condition_and([
                    ...
                    condition_or([
                        # https://www.youtube.com/watch?v=spitKAZQrB4
                        condition_and([
                        ...
                        # https://www.youtube.com/watch?v=LE2kJ08IxEU
                        condition_and([
                        ...
                        # https://www.youtube.com/watch?v=v68NS3FfSV4
                        condition_and([
                        ...
                        # https://www.youtube.com/watch?v=P6C2mDAXwjA
                        condition_and([
                ...
                condition_and([
                    ...
                    condition_or([
                        ...
                        # https://www.youtube.com/watch?v=P6C2mDAXwjA&t=28s
                        condition_and([
                            has_trick_enabled(state, player, "Bomb Space Jump"),
                            condition_or([
                                has_dark_suit(state, player),
                ...
                # https://www.youtube.com/watch?v=3UaA3tgmzX8
                condition_and([
        ...
        MetroidPrime2Exit(
            destination="Dark Agon Wastes - Save Station 2",
