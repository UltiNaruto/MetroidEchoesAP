...
class JudgmentDrop(MetroidPrime2Region):
    name = "Judgment Drop"
    exits_ = [
        MetroidPrime2Exit(
                ...
                condition_or([
                    ...
                    condition_and([
                        ...
                        condition_or([
                            ...
                            # https://www.youtube.com/watch?v=xjROhTAzEXk
                            condition_and([
                    ...
                    condition_and([
                        ...
                        condition_or([
                            # https://www.youtube.com/watch?v=2yDHWXXEXkk
                            condition_and([
                            ...
                            # https://www.youtube.com/watch?v=mexrPUDwJUU
                            condition_and([
