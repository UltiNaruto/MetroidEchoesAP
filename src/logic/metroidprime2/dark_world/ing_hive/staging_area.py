...
class StagingArea(MetroidPrime2Region):
    ...
    exits_ = [
        MetroidPrime2Exit(
            destination="P|Sanctuary Fortress - Main Research",
            door=DoorCover.Opened,
            rule=lambda state, player: condition_and([
                can_activate_dark_portal(state, player),
                condition_and([
                state.has("Ing Hive - Staging Area | Event - Unlock Portal", player),
                False,
                condition_or([
                    condition_or([
    ...
    def __init__(self, region_name: str, player: int, multiworld: MultiWorld):
        ...
        self.add_location(
            name="Event - Unlock Portal",
            locked_item=MetroidPrime2Item(
                name="Ing Hive - Staging Area | Event - Unlock Portal",
