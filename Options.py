...
class Tricks(OptionList):
    ...
    options = [
        ...
        "Agon Wastes - Bioenergy Production | NSJ SA across Containers",
        "Agon Wastes - Bioenergy Production | Scan/Combat Dash across Containers",
        "Agon Wastes - Bioenergy Production | BSJ up Container Steps",
        "Agon Wastes - Bioenergy Production | SA from Standable to Ventilation Area B Ledge",
        "Agon Wastes - Bioenergy Production | Scan/Combat Dash across Containers",
        "Agon Wastes - Bioenergy Production | Extended Dash across Containers",
        "Agon Wastes - Bioenergy Production | BSJ up Container Steps then NSJ SA to Item",
        "Agon Wastes - Bioenergy Production | SA from Standable to Item",
        "Agon Wastes - Bioenergy Production | SA from Standable to Storage C Ledge",
        "Agon Wastes - Bioenergy Production | BSJ up Container Steps then NSJ SA to Storage C Ledge",
        "Agon Wastes - Bioenergy Production | Roll Jump to Storage C Ledge",
        "Agon Wastes - Bioenergy Production | Scan/Combat Dash to Storage C Ledge",
        "Agon Wastes - Bioenergy Production | SA around Pipes",
        ...
        "Agon Wastes - Central Mining Station | BSJ up to Turret Platform",
        "Agon Wastes - Central Mining Station | Slope Jump to Center Platforms",
        "Agon Wastes - Central Mining Station | Scan/Combat Dash to Center Platforms",
        "Agon Wastes - Central Mining Station | SA from Standable to Center Platforms",
        "Agon Wastes - Central Mining Station | NSJ BSJ SA to Center Platform",
        "Agon Wastes - Central Mining Station | Scan/Combat Dash to/from Center Platforms to Turret Platform",
        "Agon Wastes - Central Mining Station | Roll Jump to/from Turret Platform to Center Platforms",
        "Agon Wastes - Central Mining Station | Extended Dash to/from Turret Platform to Center Platforms",
        ...
        "Agon Wastes - Command Center Access | Break Grates with Boost Ball",
        "Agon Wastes - Command Center Access | Break Grates with SA",
        ...
        "Agon Wastes - Main Reactor | Activate Dark Crystal Gate with SA",
        "Agon Wastes - Main Reactor | Activate Dark Crystal Gate with SA",
        "Agon Wastes - Main Reactor | 3BSJ to SA Recoil up to Ventilation Area A Side",
        "Agon Wastes - Main Reactor | BSJ onto Phazon Container",
        "Agon Wastes - Main Reactor | 2BSJ onto Railing then Jump Around to Item",
        "Agon Wastes - Main Reactor | Destroy Glass without Bombs",
        "Agon Wastes - Main Reactor | SA in Morph Exit by Item",
